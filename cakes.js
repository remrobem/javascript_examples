...
function cakes(recipe, available) {
    ...
    for (const [recipeIngredient, recipeAmount] of recipeEntries) {
        // console.log(`${recipeIngredient} ${recipeAmount}`)
        // console.log(available[recipeIngredient])
 
        quantity = quantity = Math.floor(available[recipeIngredient]  / recipeAmount ) < quantity ? Math.floor(available[recipeIngredient] / recipeAmount) : quantity;
        // console.log(Math.floor(available[ingredient] / amount)) 
